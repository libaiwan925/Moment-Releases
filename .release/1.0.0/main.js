...
@media (max-width: 560px) {
  .moments-view .moments-page-shell {
    position: relative;
  }
  ...
  .moments-view .moments-timeline-header {
    position: absolute;
    z-index: 2;
    top: calc(var(--moments-page-top) + 12px);
    right: 18px;
    align-items: center;
    gap: 0;
    margin: 0;
  ...
  .moments-view .moments-timeline-header-action::after {
  ...
  .moments-timeline-view .moments-composer-heading {
    margin-top: 34px;
  }
}
